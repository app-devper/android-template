...
object BundleJSONConverter {
    ...
    init {
        SETTERS[Boolean::class.java] = object : Setter {
        ...
        SETTERS[Int::class.java] = object : Setter {
            @Throws(JSONException::class)
            override fun setOnBundle(bundle: Bundle, key: String, value: Any) {
        ...
        SETTERS[Long::class.java] = object : Setter {
            @Throws(JSONException::class)
            override fun setOnBundle(bundle: Bundle, key: String, value: Any) {
        ...
        SETTERS[Double::class.java] = object : Setter {
            @Throws(JSONException::class)
            override fun setOnBundle(bundle: Bundle, key: String, value: Any) {
        ...
        SETTERS[String::class.java] = object : Setter {
            @Throws(JSONException::class)
            override fun setOnBundle(bundle: Bundle, key: String, value: Any) {
        ...
        SETTERS[Array<String>::class.java] = object : Setter {
            @Throws(JSONException::class)
            override fun setOnBundle(bundle: Bundle, key: String, value: Any) {
        ...
        SETTERS[JSONArray::class.java] = object : Setter {
            @Throws(JSONException::class)
            override fun setOnBundle(bundle: Bundle, key: String, value: Any) {
