...
class MemberAdapter(private val retryCallback: () -> Unit) : PagedListAdapter<Member, RecyclerView.ViewHolder>(POST_COMPARATOR) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            R.layout.item_post -> MemberViewHolder.create(parent)
