package com.devper.template.presentation.notification.viewmodel
...
import com.devper.template.presentation.notification.adapter.NotificationPageAdapter
...
class NotificationViewModel @ViewModelInject constructor(
    ...
    fun getNotifications(): Flow<PagingData<Notification>> {
        ...
        val newResult: Flow<PagingData<Notification>> = getNotificationsUseCase(1).cachedIn(viewModelScope)
