...
class FingerprintDialog : DialogFragment(), Callback {
    ...
    private val controller: FingerprintController by lazy {
        FingerprintController(FingerprintManagerCompat.from(context!!), this, titleTextView, subtitleTextView, errorTextView, iconFAB)
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? = inflater.inflate(R.layout.dialog_fingerprint, container, false)
    ...
    private fun createKey(keyName: String, invalidatedByBiometricEnrollment: Boolean) {
        ...
        try {
            ...
            val builder = KeyGenParameterSpec.Builder(keyName, KeyProperties.PURPOSE_ENCRYPT or KeyProperties.PURPOSE_DECRYPT).setBlockModes(KeyProperties.BLOCK_MODE_CBC)
    ...
    companion object {
        ...
        fun newInstance(title: String, subtitle: String, callback: Callback): FingerprintDialog {
            val args = Bundle()
